...
```{r}
hurdle_1_do = getModel("do", "Stan/hurdle_soft_test.stan", back = F)
```
...
```{r}
hurdle_1_do = getModel("'d", "Stan/gen_pois_hurdle2.stan", back = F)
```

```{r}
d_hurdle = Hurdle_Pois_Quantities(hurdle_1_do, do, back = F, hurdle = 1)
```
